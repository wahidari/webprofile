                    ...
                    <div className="card border-0 shadow-custom px-3 pt-3 text-nowrap">
                        <div className="table-responsive">
                            <table className="table table-borderless">
                                <tbody>
                                    <tr>
                                        <td className="w-8">Nama</td>
                                        <td className="w-2">:</td>
                                        <td>{pembangunan.nama_pembangunan}</td>
                                    </tr>
                                    <tr>
                                        <td className="w-8">Sumber</td>
                                        <td className="w-2">:</td>
                                        <td>{pembangunan.sumber_dana}</td>
                                    </tr>
                                    <tr>
                                        <td className="w-8">Tahun</td>
                                        <td className="w-2">:</td>
                                        <td>{pembangunan.tahun}</td>
                                    </tr>
                                    <tr>
                                        <td className="w-8">Dusun</td>
                                        <td className="w-2">:</td>
                                        <td>{pembangunan.dusun.nama_dusun}</td>
                                    </tr>
                                    <tr>
                                        <td className="w-8">RW</td>
                                        <td className="w-2">:</td>
                                        <td>{pembangunan.rw.rw_nama}</td>
                                    </tr>
                                    <tr>
                                        <td className="w-8">RT</td>
                                        <td className="w-2">:</td>
                                        <td>{pembangunan.rt.rt_nama}</td>
                                    </tr>
                                    <tr>
                                        <td className="w-8">Progress</td>
                                        <td className="w-2">:</td>
                                        <td>
                                            {pembangunan.progress ?
                                                <div className="progress rounded-pill">
                                                    {pembangunan.progress > 0 && pembangunan.progress < 25 ?
                                                        ...
                                                        : pembangunan.progress > 24 && pembangunan.progress < 50 ?
                                                        ...
                                                        : pembangunan.progress > 49 && pembangunan.progress < 75 ?
